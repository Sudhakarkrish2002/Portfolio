  ...
  return (
    <Section id="about" title="About Me">
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div>
          <h3 className="text-2xl font-semibold mb-4 text-blue-300">Personal Biography</h3>
          ...
          <h3 className="text-2xl font-semibold mb-4 text-blue-300">Educational Background</h3>
        ...
        <div className="card p-8">
          <h3 className="text-2xl font-semibold mb-6 text-blue-300 text-center">Skills & Expertise</h3>
          {/* Skill Timeline */}
